...
export const InfluencersList = ({ influencers, fetchingState }) => {
    return (
        <>
            {fetchingState === "idle" ? <p className='text-white text-center mt-[150px]'>Enter the prompt and hit the find buttong to find influencers</p> : fetchingState === "error" ? <p className='text-white text-center mt-[150px]'>Something went wrong while fetching please try ageain</p> : fetchingState === "loading" ? <p className='text-white text-center mt-[150px]'>Fetching influencers Please wait</p> : <div className='flex flex-col gap-[20px] mt-[150px]'>
                {
